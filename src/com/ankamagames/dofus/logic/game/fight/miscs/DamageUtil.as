package com.ankamagames.dofus.logic.game.fight.miscs
{
			...
			public class DamageUtil extends Object
			{
						...
						public static const TARGET_HP_BASED_DAMAGE_EFFECTS_IDS:Array;
						...
						public static function verifySpellEffectMask(pCasterId:int, pTargetId:int, pEffect:EffectInstance, pSpellImpactCell:int, pTriggeringSpellCasterId:int = 0) : Boolean
						{
									// Décompilation abandonné
						}
						...
						public static function getSpellElementDamage(pSpell:Object, pElementType:int, pCasterId:int, pTargetId:int, pSpellImpactCell:int) : SpellDamage
						{
									// Décompilation abandonné
						}
