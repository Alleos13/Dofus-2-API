package com.ankamagames.dofus.network.messages.game.context.roleplay.treasureHunt
{
   ...
   public class PortalUseRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PortalUseRequestMessage(param1:IDataOutput) : void
      {
         //Décompilation abandonné
      }
      ...
      public function deserializeAs_PortalUseRequestMessage(param1:IDataInput) : void
      {
         //Décompilation abandonné
      }
   }
