package com.ankamagames.dofus.network.messages.game.context.roleplay.treasureHunt
{
   ...
   public class TreasureHuntDigRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_TreasureHuntDigRequestMessage(param1:IDataOutput) : void
      {
         //Décompilation abandonné
      }
      ...
      public function deserializeAs_TreasureHuntDigRequestMessage(param1:IDataInput) : void
      {
         //Décompilation abandonné
      }
   }
